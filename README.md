...
4. 为英文标题和摘要生成中文翻译，并复用本地翻译缓存；
5. 尽量平衡国内与海外新闻，并限制单一来源占比，最多保留 40 条；
6. 更新 `app/generated-news.json` 与 `app/translation-cache.json` 并记录到 Git 历史；
7. 导出静态网站并部署到 GitHub Pages。
